...
import { QRType } from '@type/models/common';
      ...
      <View style={styles.centeredView}>
        <Animated.View
          ...
          <View gap={4}>
            <Text
              center
              type="subtitle2Medium"
              color={
                type === QRStatus.CLOCK_IN ? 'SUCCESS_MAIN' : 'DANGER_MAIN'
              }>
              {title}
            </Text>
          ...
          <Image source={imageQR} contentFit="cover" style={styles.imageQR} />
          <Button
            label="Close"
